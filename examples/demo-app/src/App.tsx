...
const PRODUCTS = [
  {
    ...
    desc: '库存服务崩',
    emoji: '🔥',
    grad: 'linear-gradient(135deg,#FF6B6B,#EE5253)',
  },
  {
    name: '跨境款',
    price: 199,
    ...
    desc: '网关错误',
    emoji: '🌍',
    grad: 'linear-gradient(135deg,#54A0FF,#2E86DE)',
  },
  {
    name: '限量款',
    price: 299,
    ...
    desc: '服务过载',
    emoji: '⭐',
    grad: 'linear-gradient(135deg,#A55EEA,#8854D0)',
  },
  {
    name: '历史款',
    price: 49,
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        ...
        >
          <div>
            ...
            >
              每个操作都会故意触发错误，用于演示 FailWatch 监控
            </Typography.Text>
          </div>
        ...
        <div
          style={{
            ...
            padding: '10px 14px',
            marginBottom: 16,
            color: dark ? '#FFD166' : '#D97706',
            fontSize: 14,
          }}
        >
          ⚠️ 本页面故意触发错误，用于演示 FailWatch
          监控——点击任意操作都会真实上报
        </div>
        ...
        >
          {PRODUCTS.map((p) => (
            <Card
              key={p.name}
              size="small"
              styles={{ body: { padding: '36px 12px 12px' } }}
        ...
        <Card size="small" style={{ marginTop: 16 }}>
          ...
          >
            ...
            >
              ...
              <Button type="primary" size="small" onClick={handleCheckout}>
                去结算
              </Button>
            </div>
          </div>
        ...
        >
          Powered by FailWatch SDK · 错误已全部上报至监控台
        </Typography.Text>
      </div>
    </div>
  )
